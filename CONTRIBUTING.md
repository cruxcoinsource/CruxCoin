Contributing to CruxCoin Core
============================

The CruxCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CruxCoin Core project, and is not to be
confused with overall CruxCoin Network Protocol consensus changes.

Whether a pull request is merged into CruxCoin Core rests with the project merge
...
Patches that change CruxCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the CruxCoin consensus, it must have been
...
The project leader is the release manager for each CruxCoin Core release.
