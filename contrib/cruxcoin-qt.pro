...
RESOURCES += src/qt/cruxcoin.qrc src/qt/cruxcoin_locale.qrc

TRANSLATIONS += src/qt/locale/cruxcoin_bg.ts \
                src/qt/locale/cruxcoin_de.ts \
                src/qt/locale/cruxcoin_en.ts \
                src/qt/locale/cruxcoin_es.ts \
                src/qt/locale/cruxcoin_fi.ts \
                src/qt/locale/cruxcoin_fr.ts \
                src/qt/locale/cruxcoin_it.ts \
                src/qt/locale/cruxcoin_ja.ts \
                src/qt/locale/cruxcoin_pl.ts \
                src/qt/locale/cruxcoin_pt.ts \
                src/qt/locale/cruxcoin_ru.ts \
                src/qt/locale/cruxcoin_sk.ts \
                src/qt/locale/cruxcoin_sv.ts \
                src/qt/locale/cruxcoin_vi.ts \
                src/qt/locale/cruxcoin_zh_CN.ts \
                src/qt/locale/cruxcoin_zh_TW.ts
