...
#   c) node1 mines 32 blocks, so now node 0 has 60001cux, node 1 has 4250cux, node2 has none.
#   d) node0 sends 601 cux to node2, in two transactions (301 cux, then 300 cux).
