...
In order to support loading of multiple wallets in cruxcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cruxcoin.cpp.
...
Changes to cruxcoin.cpp
----------------------
cruxcoin.cpp is the entry point into cruxcoin-qt, and as such, will require some minor modifications to provide hooks for
