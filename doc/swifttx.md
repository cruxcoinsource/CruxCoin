...
This mechanism has been integrated into Bitcore-Node-CruxCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/CruxCoin-Project/insight-api-cruxcoin#web-socket-api](https://github.com/CruxCoin-Project/insight-api-cruxcoin#web-socket-api) 
* API: [https://github.com/CruxCoin-Project/insight-api-cruxcoin#swifttx-transactions](https://github.com/CruxCoin-Project/insight-api-cruxcoin#swifttx-transactions) 
...
By default, the CruxCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the CruxCoin Core daemon:
