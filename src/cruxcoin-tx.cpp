...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CruxCoin Core cruxcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cruxcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cruxcoin transaction") + "\n" +
                               "  cruxcoin-tx [options] -create [commands]   " + _("Create hex-encoded cruxcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cruxcoin transaction
