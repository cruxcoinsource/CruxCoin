...
/** 
    ...
    ****Note - for CruxCoin we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of cruxcoin coming in to a transaction
