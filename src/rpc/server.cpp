...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop CruxCoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "CruxCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CruxCoin features */
        {"cruxcoin", "masternode", &masternode, true, true, false},
        {"cruxcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"cruxcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cruxcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cruxcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"cruxcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"cruxcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"cruxcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cruxcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"cruxcoin", "startmasternode", &startmasternode, true, true, false},
        {"cruxcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cruxcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cruxcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cruxcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cruxcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cruxcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cruxcoin", "mnbudget", &mnbudget, true, true, false},
        {"cruxcoin", "preparebudget", &preparebudget, true, true, false},
        {"cruxcoin", "submitbudget", &submitbudget, true, true, false},
        {"cruxcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"cruxcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"cruxcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"cruxcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"cruxcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"cruxcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"cruxcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cruxcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"cruxcoin", "mnsync", &mnsync, true, true, false},
        {"cruxcoin", "spork", &spork, true, true, false},
        {"cruxcoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzcuxseed", &getzcuxseed, false, false, true},
        {"zerocoin", "setzcuxseed", &setzcuxseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzcux", &searchdzcux, false, false, true},
        {"zerocoin", "dzcuxstate", &dzcuxstate, false, false, true}
...
{
    return "> cruxcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:29117/\n";
}
