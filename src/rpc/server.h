...
/**
 * CruxCoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzcuxseed(const UniValue& params, bool fHelp);
extern UniValue getzcuxseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzcux(const UniValue& params, bool fHelp);
extern UniValue dzcuxstate(const UniValue& params, bool fHelp);
