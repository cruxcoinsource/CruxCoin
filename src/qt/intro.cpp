...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("CruxCoin Core"),
     ...
     * override -datadir in the cruxcoin.conf file in the default data directory
     * (to be consistent with cruxcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
