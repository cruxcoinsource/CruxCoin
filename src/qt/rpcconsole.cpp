                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzCUXPathCustom = GetArg("-zcuxbackuppath", "");
    ...
    if(!strzCUXPathCustom.empty()) {
        ui->wallet_customzcuxbackuppath->setText(QString::fromStdString(strzCUXPathCustom));
        ui->wallet_customzcuxbackuppath_label->setVisible(true);
        ui->wallet_customzcuxbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzCUXPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the CruxCoin RPC console.") + "<br>" +
