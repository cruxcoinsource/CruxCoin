...
/* CruxCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "CruxCoin"
#define QAPP_ORG_DOMAIN "cruxcoin.org"
#define QAPP_APP_NAME_DEFAULT "CruxCoin-Qt"
#define QAPP_APP_NAME_TESTNET "CruxCoin-Qt-testnet"
