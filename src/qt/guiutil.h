...
/** Utility functions used by the CruxCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render CruxCoin addresses in monospace font
...
// Parse "cruxcoin:" URI into recipient object, return true on successful parsing
